...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'usernameOrEmail') String usernameOrEmail,
      String password});
}
...
class _$LoginRequestImpl implements _LoginRequest {
  const _$LoginRequestImpl(
      {@JsonKey(name: 'usernameOrEmail') required this.usernameOrEmail,
...
abstract class _LoginRequest implements LoginRequest {
  const factory _LoginRequest(
      {@JsonKey(name: 'usernameOrEmail') required final String usernameOrEmail,
